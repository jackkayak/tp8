...
$recipes["RaspberryStreuselTart"]["directions"][4] = "Sprinkle crumbs onto a large shallow pan. Repeat until all the mixture has been made into crumbs. Place crumbs in oven and bake for 15 to 18 minutes until they turn light brown. Set streusel mixture aside to cool and harden.Pour condensed milk over
        nuts.";
$recipes["RaspberryStreuselTart"]["directions"][5] = "Heat cream in a 2-quart saucepan until just under a boil. In a small bowl, combine 1/3 cup sugar and cornstarch. Beat egg yolks in a mixing bowl with a whisk until slightly thickened. Whisk in sugar-cornstarch mixture. Gradually pour in hot cream,
...
$recipes["RaspberryStreuselTart"]["directions"][6] = "After custard reaches a boil, simmer about 1 minute. Remove from heat. Stir in 1 tablespoon butter, vanilla, and Kirschwasser or framboise. Cover custard with a piece of buttered plastic wrap. Cool about 10 minutes";
$recipes["RaspberryStreuselTart"]["directions"][7] = "Spread custard into a prebaked tart shell and bake for until bubbly, 20 to 25 minutes. Remove from oven and cool on a rack for 10 minutes to set.";
$recipes["RaspberryStreuselTart"]["directions"][8] = "Combine preserves and water in a small saucepan. Heat until mixture comes to a boil. Pass the glaze through a fine-mesh strainer. Discard pulp.";
$recipes["RaspberryStreuselTart"]["directions"][9] = "Gently brush top of custard with half of the hot preserves. Sprinkle berries generously over hot custard. Lightly brush tops of berries with remaining preserves. Sprinkle tart generously with streusel, pressing the crumbs gently into the berries
